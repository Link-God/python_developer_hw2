...
# в init специально не добавил возмодность инициализации,
# тк не логично задавать какие-то значения при описании дескрипторов в классе

# None для того что бы если в будущем коту-то захочется неиницилизированые дескрипторы

# разнес все в разные классы и без наследования от базового так везде есть элементы своей логики,
# которую в будущем можно будет расширить
# А делать наследование для того чтобы не писать get везде
# и для этого делать имя полей одинаковыми посчитал нецелесообразным
